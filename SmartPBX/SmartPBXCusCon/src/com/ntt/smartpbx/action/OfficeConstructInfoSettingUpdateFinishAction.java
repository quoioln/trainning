...
/**
 * 名称: OfficeContructInfoSettingUpdateFinishAction class.
 * 機能概要: Process update information of office construct finish
 */

public class OfficeConstructInfoSettingUpdateFinishAction extends BaseAction {
    /** The serial version default. */
    private static final long serialVersionUID = 1L;
    /** The logger. */
    // Start step 2.5 #1946
    private static Logger log = Logger.getLogger(OfficeConstructInfoSettingUpdateFinishAction.class);
    // End step 2.5 #1946
    /**The action type. */
     ...
     * Constructor.
     */
    public OfficeConstructInfoSettingUpdateFinishAction() {
        super();
