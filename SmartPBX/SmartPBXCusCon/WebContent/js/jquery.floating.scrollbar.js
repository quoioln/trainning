...
(function($) {
    ...
    // Call on elements to monitor their position and scrollness. Pass `false`
    // to
    ...
    // Call this to force an update, for instance, if elements were inserted
    // into
    ...
    function update() {
        ...
        // below the viewport.
        elems.each(function() {
            var elem = $(this), top = elem.offset().top, bottom = top
                    + elem.height(), viewportBottom = win.scrollTop()
                    + win.height(), topOffset = 30;
       ...
       // scrollMax = current.scrollLeft(90019001).scrollLeft(), 
        ...
        widthInner = current[0].scrollWidth;//widthOuter + scrollMax;
