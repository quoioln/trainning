...
<div id="tutorial" class="clearfix">
...
<div class="cMain">
    <p>
        <s:text name="g0703.OutsideIncomingInfoAdd" />
    </p>
    ...
    <form name="mainForm">
        <table class="style-table tableTypeS">
            ...
            <tr>
                ...
                <!-- Start #930 -->
                <!-- Start step2.6 #IMP-2.6-02 -->
                <s:if test="%{data.outsideCallServiceType == 2}">
                    <s:if
            ...
            <tr>
                ...
                <td  style="white-space: normal; word-break: break-all;"><s:if
                        ...
                        <s:property value="data.serverAddress" /></s:if>
        ...
        <!--         Start IMP-step2.5-04 -->
        <div id="hidden">
            <input type="hidden" id="tutorial_flag"
