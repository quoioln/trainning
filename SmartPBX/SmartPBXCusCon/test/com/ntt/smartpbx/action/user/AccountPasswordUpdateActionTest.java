...
// #1910 START
public class AccountPasswordUpdateActionTest {
    
    /** ロガーインスタンス */
    public static Logger log = Logger.getLogger(AccountPasswordUpdateActionTest.class);
    ...
    /** モックの差し込み対象 */
    @InjectMocks
    private static AccountPasswordUpdateAction accountPasswordUpdateAction = new AccountPasswordUpdateAction();
    ...
    public void setUp() throws Exception {
        ...
        accountInfo.setLoginId("login1");
        accountInfo.setPasswordHistory1("login1");
        accountInfo.setPasswordHistory2("");
        accountInfo.setPasswordHistory3(null);
    }
    ...
    public void testAutoPassWd() 
        ...
        //privateメソッドを呼び出す
        Method method = AccountPasswordUpdateAction.class.getDeclaredMethod("autoPassWd",AccountInfo.class );
        method.setAccessible(true);
        
        for(int i=0;i<MAX_TEST_REPEAT;i++){
            String actual = (String) method.invoke(accountPasswordUpdateAction, accountInfo );
