...
// #1910 START
public class PasswordUpdateActionTest {

    /** ロガーインスタンス */
    public static Logger log = Logger.getLogger(PasswordUpdateActionTest.class);
    ...
    /** モックの差し込み対象 */
    @InjectMocks
    private static PasswordUpdateAction passwordUpdateAction = new PasswordUpdateAction();
    ...
    private void executeInputValidation(
        ...
        try{
            // 引数セット
            passwordUpdateAction.setLoginId(loginId);
            passwordUpdateAction.setOldPassword(oldPassword);
            passwordUpdateAction.setNewPassword1(newPassword1);
            passwordUpdateAction.setNewPassword2(newPassword2);
            // 関数実行
            passwordUpdateAction.inputValidation();
